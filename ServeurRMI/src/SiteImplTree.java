...
public class SiteImplTree extends UnicastRemoteObject implements SiteItf {
	...
	public SiteImplTree(String name) throws RemoteException {
		this.name = name;
		this.monNum = Integer.parseInt(name);
		this.fils = new ArrayList<SiteItf>();
		this.sons = new ArrayList<String>();
	}
	
	public SiteImplTree(SiteItf pere) throws RemoteException {
		this.pere = pere;
		this.monNum = SiteImplTree.num++;
		this.fils = new ArrayList<SiteItf>();
	}
